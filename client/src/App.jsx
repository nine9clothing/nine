...
// const targetDate = new Date('2025-05-09T21:00:00+05:30').getTime(); // Updated to 9  PM IST
//   useEffect(() => {
//     const checkIfLive = () => {
...
//             {/* Conditionally render ComingSoon or Home for the root path */}
//             <Route path="/" element={isLive ? <Home /> : <ComingSoon />} />
